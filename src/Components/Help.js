            ...
            <div id='faq-page-layout'>
                ...
                <div>
                    <div>
                        ...
                        <p>Click <a href="https://tarheels.live/comp523s23teaml/d4-documentation/" target='_blank'>here</a> to see the User Manual.</p>
                    </div>
                    <div>
                        <h5 className='title'> 2. What is Kinetik Simulation? </h5>
                    ...
                    <div>
                        <h5 className='title'> 3. What types of data can be uploaded to the Kinetik Simulation application? </h5>
                    ...
                    <div>
                        <h5 className='title'> 4. How do I upload my data to the Kinetik Simulation application? </h5>
                    ...
                    <div>
                        <h5 className='title'> 5. How do I select the time period for my simulation? </h5>
                    ...
                    <div>
                        <h5 className='title'> 6. How do I run a simulation? </h5>
                    ...
                    <div>
                        <h5 className='title'> 7. Can I modify my uploaded data after the simulation has started? </h5>
                    ...
                    <div>
                        <h5 className='title'> 8. How long does it take for the simulation to complete? </h5>
                    ...
                    <div>
                        <h5 className='title'> 9. What is a go-to-market profile? </h5>
                    ...
                    <div>
                        <h5 className='title'> 10. Can the Kinetik Simulation application be used for forecasting? </h5>
                    ...
                    <div>
                        <h5 className='title'> 11. Is it possible to perform scenario analysis with the Kinetik Simulation application? </h5>
                    ...
                    <div>
                        <h5 className='title'> 12. How do I view the results of my simulation? </h5>
                    ...
                    <div>
                        <h5 className='title'> 13. hat level of technical knowledge is required to use the Kinetik Simulation application? </h5>
                    ...
                    <div>
                        <h5 className='title'> 14. What is the difference between the Kinetik Simulation application and other forecasting applications? </h5>
                    ...
                    <div>
                        <h5 className='title'> 15. How can I get help if I encounter issues with the Kinetik Simulation application? </h5>
